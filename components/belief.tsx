export function Belief() {
  return (
    <section className="relative min-h-[633px] overflow-hidden bg-black text-white">
      <img src="/images/gallery-2.png" alt="Warm interior with natural light" className="absolute inset-0 h-full w-full object-cover" />
      ...
      <div className="relative z-10 flex min-h-[633px] flex-col px-6 py-7 md:px-12 md:py-8">
        ...
        <div className="mx-auto my-auto w-full max-w-[360px]">
          <p className="text-[18px] font-semibold leading-[1.18] tracking-[-.025em]">A beautiful space doesn&apos;t happen by accident. It happens through listening, understanding, and making hundreds of intentional choices - each one quietly working together until the space finally feels right.</p>
